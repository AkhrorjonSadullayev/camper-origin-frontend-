...
export default function TemporaryDrawer() {
  ...
  const DrawerList = (
    ...
    <Box
      sx={{ width: 300, padding: 2 }} // Styling the width and padding of the Drawer
      role="presentation"
    >
      <AccordionCon>
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        anchor="right" // Drawer will slide in from the left
      >
        {DrawerList} {/* Render DrawerList which includes the Accordion */}
      </Drawer>
    </div>
  );
}
