...
export const UsedCarGrid = styled.div`
display: grid;
...
export const UsedCarMenu = styled.div`
width: 223px;
height: 307px;
border-radius: 20px;
background: #FFF;
...
`;
export const UsedDetail = styled.div`
.add-but{
    padding: 15px;
    width: 181.5px;
height: 50.014px;
...
`;
export const UsedDetailMenu = styled.div`
.detailsmenu{
    display: flex;
    margin-top: 10px;
    align-items: center;
...
`;
export const UsedContainer = styled.div`
`; 
