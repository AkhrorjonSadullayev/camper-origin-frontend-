...
import { Caravandetails, CaravandetailsMenu, VanContainer } from '../styles/caravan'
import { Link, useParams } from 'react-router-dom'
import { CaravanCar } from './caravan';
...
const Vandetails = () => {
  const { id } = useParams();
  const vanDetail = CaravanCar.MainDataCaravan
  const FilterVanDetail = vanDetail.filter((value)=>value.id === parseInt(id))
  console.log(FilterVanDetail);
  return (
    <div>
     <Caravandetails className='caravanBackgtoungimg'>
    ...
    <CaravandetailsMenu>
      {FilterVanDetail.map((value,index)=>{
        return(
          <div key={index}>
      ...
      {/* first container end */}
      <VanContainer className='container1'>
     ...
     <VanContainer className='container2'>
                 <div>
